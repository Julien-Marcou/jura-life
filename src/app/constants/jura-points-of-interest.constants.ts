...
<a href="https://www.paysdegex-montsjura.com/domaine-ski-vtt/domaine-de-ski-alpin-de-mijoux-la-faucille/" target="_blank">paysdegex-montsjura.com<span class="material-icons" aria-hidden="true">open_in_new</span></a>`,
  ...
  'patinoire-premanon': {
    ...
    type: PinType.Rink,
    description: '<a href="https://www.espacedesmondespolaires.org/" target="_blank">espacedesmondespolaires.org<span class="material-icons" aria-hidden="true">open_in_new</span></a>',
    isWinterExclusive: false,
    isSummerExclusive: false,
    isIndoor: true,
    isLandscape: false,
  ...
  'base-nautique-bellecin': {
    ...
    description: '<a href="https://www.bellecin.com/location-de-materiel/" target="_blank">bellecin.com<span class="material-icons" aria-hidden="true">open_in_new</span></a>',
    photospheres: [
  ...
  'centre-equestre-tinguely': {
    ...
    description: '<a href="https://centre-equestre-tinguely.com/" target="_blank">centre-equestre-tinguely.com<span class="material-icons" aria-hidden="true">open_in_new</span></a>',
    isWinterExclusive: false,
    isSummerExclusive: false,
    isIndoor: false,
    isLandscape: false,
