...
export const JuraPointsOfInterest: Record<string, SerializedPointOfInterest> = {
  ...
  'yourte-rosset': {
    ...
    description: `<a href="https://sentierslibres.fr/activites/#nocturneinsolite" target="_blank">sentierslibres.fr<span class="material-icons">open_in_new</span></a>`,
    isWinterExclusive: false,
    isSummerExclusive: false,
    isIndoor: false,
    isLandscape: false,
  ...
  'belvedere-grand-saut': {
    ...
    latitude: 46.61412371770717,
    longitude: 5.859462118245684,
    type: PinType.ScenicViewpoint,
    isWinterExclusive: false,
    isSummerExclusive: false,
    isIndoor: false,
  ...
  'cascade-saut-forge': {
    ...
    latitude: 46.61418909157672,
    longitude: 5.868862182557182,
    type: PinType.Waterfall,
    isWinterExclusive: false,
    isSummerExclusive: false,
    isIndoor: false,
